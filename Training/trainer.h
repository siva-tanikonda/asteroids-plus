...
struct TrainerStage {
    int seed, seed_count, trial_count, generations_count, carry_over_count, combination_count;
    double mutation_rate, shift_mutation_rate, mutation_weight, softmax_weight, catch_up_threshold, exploration_threshold, exploration_multiplier, fitness_weights[EVALUATION_METRICS];
    pair<double, double> weight_ranges[C_LENGTH];
    vector<vector<int>> c_groups;
};
...
class Trainer {
    ...
    private:
        ...
        bool old_click, done, progressed_seed;
